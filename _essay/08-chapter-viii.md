...
of Natural Form in Design—The Outward Vision and
the Inner Vision.
...
form exactly as it appears—a power always valuable
...
I have spoken of the graphic and the ornamental
...
characteristics—be they of figure, flower, or landscape—is
*another*. Both belong to the thing we
...
Studies, for instance, made with a view to arrangements
of *line* only—to get the characteristic
...
In both directions some compact or compromise
...
Design motive, individual conception and sentiment,
...
But a design once started upon some principle—some
particular motive of line or form—then,
...
treatment—a certain natural consistency or harmony—from
...
decorative designs, and pattern inventions.
...
vividness of actuality—the tangible forms of external
...
But the inner vision is not bound by the appearances
...
*space* rather than landscape: race rather than
...
The inner vision re-creates rather than represents,
