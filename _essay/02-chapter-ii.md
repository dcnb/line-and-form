...
Purpose—Aspect—The Ornamental Purpose—Typical Treatment
or Convention—Rhythm—Linear Plans in Pattern Designing—Wall-paper
Design—Controlling Forms—Memory—Evolution
in Design—Variety in Unity—Counterbalance—Linear
Logic—Recurring Line and Form—Principle of Radiation—Range
and Use of Line.
...
The endless variations which result I should—to
pursue the analogy of speech further—term
*dialects*. We might collect abundant examples
...
Dürer (to get a contrast in historic style). Compare
...
and so on, down to the hair-line of the drypoint etcher.
...
of its inseparable companion, *Form*.
...
- The Graphic Purpose. (Accidental form.)
- The Ornamental Purpose. (Typical form.)
...
study and careful constant practice—*knowledge
...
special methods and materials—intended to decorate
...
understood and appreciated, as a rule. Pattern-work
...
design—that is, a design intended to adorn or to
...
At the same time the imagination can be enfeebled
...
suggest or necessitate—as by a kind of
logic—another, one adds other forms until the design
...
of the living forms of nature—first the blade,
...
forms, as the mediæval heraldic designers were
...
each side, or *vice versâ*; or, adopting a diagonal
...
is a species of linear reasoning,[1] and might
...
himself that radiates his light upon it. The palm-leaf
...
We see, therefore, that line possesses a constructive
...
perpetuate in imperishable notation unheard harmonies:
